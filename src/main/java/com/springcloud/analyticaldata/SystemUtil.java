...
public class SystemUtil {
    ...
    public static void main(String[] args)
    {
        ...
        data.put("appKey","70D10DFCF99C5D1");
        ...
        HashMap<String,String> restJson=invoke("http://39.98.246.54/Jizn/api.rest","IOpenAPI.GetOrder","70D10DFCF99C5D1","95DD5ECAA4AC25B6BD","json",data);
